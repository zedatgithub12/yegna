...
const AttachPhoneNumber = ({ customerCode }: Props) => {
  ...
  const [currentStep, setCurrentStep] = React.useState<number>(2); //step one send otp step 2 verify otp
...
export default AttachPhoneNumber;
