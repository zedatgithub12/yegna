...
const TrashDetailMessage = ({ message, goBack }: MessageDetailPageProps) => {
    ...
    openModal({
      view: (
        <DeleteRecord
          ...
          url={`${queryKeys.get_all_trash_message_broadcasts}/${id}`}
          onRefresh={() =>
            queryClient.invalidateQueries({
              queryKey: [queryKeys.get_all_trash_message_broadcasts],
            })
          }
...
export default TrashDetailMessage;
