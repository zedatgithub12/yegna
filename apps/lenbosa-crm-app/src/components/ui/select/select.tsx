...
import { ExtractProps } from "@/utils/lib/extract-props";
...
import { dropdownStyles } from "@/utils/lib/dropdown-list-style";
...
export type SelectProps<SelectOption> = ExtractProps<typeof Listbox> & {
  ...
  // message to display when there are no options default is "No options"
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    "block w-full truncate text-left rtl:text-right capitalize",
                ...
                >
                  ...
                  >
                    ...
                    {filteredOptions.length === 0 && (
                      <Text className="px-3 py-1.5 text-center">
