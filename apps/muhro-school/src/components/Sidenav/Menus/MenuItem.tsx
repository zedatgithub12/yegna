...
const CollapsableMenu = ({
  ...
  <div className="w-11/12">
    <div
      className={`group flex items-center justify-between gap-4 p-2 pl-3 py-2.5  cursor-pointer font-medium rounded-lg mx-1
...
const UncollapsableMenu = ({
  ...
  <div
    onClick={onPress}
    className={`group w-11/12 flex items-center ${drawerOpen ? "pl-4" : "justify-center"} gap-4 p-2 py-2.5   cursor-pointer font-medium rounded-lg mx-1 
  ...
  >
    ...
    {drawerOpen ? (
      <Text
        className="text-[15px] font-outfit font-normal text-inherit transition-colors duration-300 ease-in line-clamp-1"
    ...
    <>
      {item.collapsable ? (
        ...
        >
          ...
          >
            <div
              className={`min-w-1.5 max-w-1/12 h-10  ${
